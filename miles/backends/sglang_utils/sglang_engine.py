...
def _compute_server_args(
    ...
    *,
    ...
    base_server_arg_values = args.sglang.base_server_arg_values
    ...
    kwargs = {
        ...
        "dp_size": base_server_arg_values["dp_size"],
        "pp_size": base_server_arg_values["pp_size"],
        "ep_size": base_server_arg_values["ep_size"],
    ...
    for attr in dataclasses.fields(ServerArgs):
        if worker_type == WorkerType.DECODE and attr.name == "enable_hierarchical_cache":
            continue
        if attr.name in base_server_arg_values and attr.name not in kwargs:
            kwargs[attr.name] = base_server_arg_values[attr.name]
