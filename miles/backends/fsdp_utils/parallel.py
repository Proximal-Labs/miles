...
def create_fsdp_parallel_state(args: Namespace) -> ParallelState:
    ...
    meshes = build_fsdp_meshes(
        ...
        dp_replicate_size=args.trainer_backend.dp_replicate_size,
    )
    dp_mesh = meshes["dp"]
    ...
    logger.info(
        ...
        f"dp_replicate_size={args.trainer_backend.dp_replicate_size}, "
        f"dp_shard_size={world_size // args.trainer_backend.dp_replicate_size}, "
        f"dp_rank={rank}"
    )
