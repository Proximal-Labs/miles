    ...
    try:
        ...
        if args.megatron_to_hf_mode == "raw" and not is_lora_model(model):
            ...
            export_hf_model_direct(
                ...
                quantization_config=getattr(hf_config, "quantization_config", None),  # config-access-exempt: model-family schemas differ in optional quantization_config metadata
