...
def postprocess_hf_param(args, megatron_param_name, hf_param_name, param):
    param = remove_padding(megatron_param_name, param, args.trainer_backend.vocab_size)
    # TODO support quant
    return param
...
def convert_to_hf(args, model_name, name, param, quantization_config=None):
    param = remove_padding(name, param, args.trainer_backend.vocab_size)
...
def _convert_to_hf_core(args, model_name, name, param):
    ...
    if (
        ...
        converted_named_tensors = convert_deepseekv3_to_hf(args.trainer_backend, name, param)
    elif "glm4moe" in model_name:
        converted_named_tensors = convert_glm4moe_to_hf(args.trainer_backend, name, param)
    elif "glm4" in model_name:
        converted_named_tensors = convert_glm4_to_hf(args.trainer_backend, name, param)
    elif "qwen3moe" in model_name:
        converted_named_tensors = convert_qwen3moe_to_hf(args.trainer_backend, name, param)
    elif "qwen3next" in model_name:
        converted_named_tensors = convert_qwen3_next_to_hf(args.trainer_backend, name, param)
    elif "qwen3_5" in model_name or "qwen3_6" in model_name:
        converted_named_tensors = convert_qwen3_5_to_hf(args.trainer_backend, name, param)
    elif "qwen2" in model_name or "qwen3" in model_name:
        converted_named_tensors = convert_qwen2_to_hf(args.trainer_backend, name, param)
        ...
        converted_named_tensors = convert_llama_to_hf(args.trainer_backend, name, param)
    elif "mimo" in model_name:
        converted_named_tensors = convert_mimo_to_hf(args, name, param)
    elif "kimivl" in model_name:
        converted_named_tensors = convert_kimivl_to_hf(args.trainer_backend, name, param)
    elif "kimi_k25" in model_name:
        converted_named_tensors = convert_kimi_k25_to_hf(args.trainer_backend, name, param)
    else:
