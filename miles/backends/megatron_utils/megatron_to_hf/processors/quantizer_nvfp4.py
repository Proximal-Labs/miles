...
def quantize_params_nvfp4(args, megatron_name, converted_named_params, quantization_config):
    ...
    if args is not None and bool(
        getattr(args.trainer_backend, "fp4_param", False) or getattr(args.trainer_backend, "fp4_param_gather", False)
    ):
    ...
    if getattr(args.trainer_backend, "first_last_layers_bf16", False):
        num_layers = int(args.num_layers)
        num_layers_at_start_in_bf16 = int(getattr(args.trainer_backend, "num_layers_at_start_in_bf16", 0))
        num_layers_at_end_in_bf16 = int(getattr(args.trainer_backend, "num_layers_at_end_in_bf16", 0))
