    ...
    *,
    ...
    if ep_sharded_provider:
        ...
        save_native_adapter_dist_checkpoint(
            ...
            optimizer=None if getattr(args, "no_save_optim", False) else optimizer,
...
def load_lora_adapter(
    ...
    *,
    ...
    if optimizer is None:
        ...
        iteration = _apply_training_state(training_state, optimizer, opt_param_scheduler, load_optimizer)
    else:
        iteration = None
