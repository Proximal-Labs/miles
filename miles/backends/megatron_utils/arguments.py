...
def set_default_megatron_args(args):
    ...
    args.use_distributed_optimizer = (args.optimizer is None or args.optimizer.lower() == "adam") and not args.debug_disable_optimizer
    ...
    if not hasattr(args, "miles_dsa_topk_backend"):  # config-access-exempt: initialize a Miles extension missing from upstream Megatron args
