...
def aggregate_forward_results(
    ...
    for key in keys:
        ...
        if args.use_dynamic_batch_size and hasattr(data_iterator, "micro_batch_indices"):  # config-access-exempt: only dynamic-batch iterators expose micro-batch indices
