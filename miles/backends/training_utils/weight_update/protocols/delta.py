...
_SAFETENSORS_DTYPE_BY_TORCH_DTYPE = {
    ...
    torch.complex64: "C64",
    **{
        getattr(torch, torch_dtype_name): safetensors_dtype  # config-access-exempt: attribute selected at runtime from torch_dtype_name
        ...
        if hasattr(torch, torch_dtype_name)  # config-access-exempt: attribute selected at runtime from torch_dtype_name
    },
}
