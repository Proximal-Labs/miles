...
from miles.utils.workers.serving.utils import parse_own_args, parse_runtime_config
from miles.utils.workers.serving.worker_identity import read_worker_identity_from_metadata
...
def main() -> None:
    ...
    inner_argv = [*python_argv_prefix(), "-m", SERVE_INNER_MODULE, *own_argv]
