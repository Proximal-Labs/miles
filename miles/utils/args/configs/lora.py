...
class LoraConfig(BaseConfig):
    ...
    multi_lora_n_adapters: A[
        int,
        Arg(help="Maximum number of concurrent adapter slots for multi-LoRA. Set to 0 to disable multi-LoRA (default: 0)"),
    ] = 0
    ...
    multi_lora_idle_poll_s: A[
        float,
        Arg(help="When no adapter is RUNNING, the trainer polls for new registrations every this many seconds (default: 5.0)"),
    ] = 5.0
