...
class ClusterConfig(BaseConfig):
    ...
    rollout_num_gpus_per_engine: A[int, Arg(help="Number of GPUs per inference engine, just like the tp_size in sglang.")] = 1
    num_gpus_per_node: A[
        int,
        Arg(
            help=(
    ...
    clear_quantized_weight_workspaces_on_offload: A[bool, Arg(
        action=argparse.BooleanOptionalAction,
        help=(
    ...
    offload_rollout: A[bool | None, Arg(
        action=argparse.BooleanOptionalAction,
        help=(
    ...
    offload_rollout_level: A[list[str], Arg(
        type_parser=str,
        nargs="+",
        help=(
    ...
    offload_train_target: A[str, Arg(
        choices=["cpu", "disk"],
        help=(
    ...
    stream_optimizer_state_to_disk: A[bool,
            Arg(
                help=(
    ...
    stream_optimizer_state_moment_dtype: A[str, Arg(
    ...
    offload_train_disk_dir: A[str | None,
            Arg(
                help=(
    ...
    offload_train_disk_chunk_mb: A[int,
            Arg(
                help=(
    ...
    colocate_memory_peak_device: A[str, Arg(
        choices=["cpu", "gpu"],
        help=(
