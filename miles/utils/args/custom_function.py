...
def add_user_provided_function_arguments(
    ...
    *,
    ...
    extra_paths: Callable[[argparse.Namespace], Iterable[str | None]],
    ...
    infos = _compute_custom_function_field_infos(args_partial, extra_paths=extra_paths(args_partial), partial=True)
