...
def namespace_to_train_args(ns: argparse.Namespace) -> str:
    ...
    if getattr(ns, "rollout_num_gpus", None) is not None:  # config-access-exempt: launcher helper accepts namespaces from different CLI providers
    ...
    if getattr(ns, "sglang_cuda_graph_max_bs_decode", None) is not None:  # config-access-exempt: launcher helper accepts namespaces from different CLI providers
    ...
    if getattr(ns, "anthropic_intermediate_system_expectation", None) is not None:  # config-access-exempt: launcher helper accepts namespaces from different CLI providers
