...
async def generate(args: Namespace, sample: Sample, sampling_params: dict[str, Any]) -> Sample:
    ...
    if state.processor and (
        ...
        prompt_ids = prompt_ids.tolist() if hasattr(prompt_ids, "tolist") else list(prompt_ids)  # config-access-exempt: tokenizers may return tensors, arrays, or Python lists
