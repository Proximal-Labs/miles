...
def spec_multi_lora_controller(args: Any) -> BaseServeSpec:
    return MultiLoraControllerSpec.create(args)
...
class MultiLoraControllerSpec(BaseServeSpec):
    ...
    def create(cls, args: Any) -> Self:
        return cls(args=MultiLoraConfig.from_config(args))
    ...
    def slice_config(self, args: Any) -> MultiLoraConfig:
