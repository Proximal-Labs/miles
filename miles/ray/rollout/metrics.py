...
from miles.utils.types import Sample, WeightVersionSpan, compute_numeric_versions_of_spans
...
def _compute_weight_version_span_metrics(
    ...
    *,
    ...
    oldest_versions = [
        version for spans in spans_by_sample if (version := min(compute_numeric_versions_of_spans(spans), default=None)) is not None
    ]
