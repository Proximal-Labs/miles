...
class StaticInferenceEngineWorkerProvider(BaseWorkerProvider):
    ...
    async def init(self) -> None:
        ...
        engines = await _discover_external_engines(urls, api_key=self._args.sglang.base_server_arg_values["api_key"])
        ...
        cells[cell_id] = _ExternalCell(
            cell_info=CellInfo(
                ...
                meta=dict(
                    ...
                    sglang_api_key=args.sglang.base_server_arg_values["api_key"],
                    needs_offload=False,
                    update_weights=True,
                ),
            ),
