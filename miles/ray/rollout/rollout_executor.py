...
class RolloutExecutor:
    ...
    async def dispose(self) -> None:
        ...
        if (close := getattr(self.data_source, "close", None)) is not None:  # config-access-exempt: custom data sources may omit this lifecycle method
            close()
    ...
    async def _generate_rollout_data(
        ...
        if (get_buffer_length := getattr(self.data_source, "get_buffer_length", None)) is not None:  # config-access-exempt: custom data sources may omit this lifecycle method
