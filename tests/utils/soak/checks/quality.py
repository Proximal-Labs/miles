...
from tests.utils.soak.state import SoakActionAppliedEvent, SoakAdmissionClosedEvent, SoakEvent, SoakObservation
...
def assert_tail_quality(
    events: list[SoakEvent], *, metric_key: str, threshold: float, min_evaluations: int = 2, trainer_id: str = "actor"
) -> None:
