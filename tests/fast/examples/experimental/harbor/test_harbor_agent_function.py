...
@pytest.mark.parametrize("attestation,report,complete", [(True, {"reward": 0.0}, True), (False, {"reward": 1.0}, False), (None, {"reward": 1.0}, False), ("true", {"reward": 1.0}, False), (True, {}, False)])
