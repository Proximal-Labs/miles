...
class TestOneDirectoryPerRolloutCheckpoint:
    ...
    def test_an_interrupted_save_publishes_nothing(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_a_fresh_run_restores_nothing(self, tmp_path: Path) -> None:
    ...
    def test_a_run_that_saves_nowhere_writes_nothing(self, tmp_path: Path) -> None:
