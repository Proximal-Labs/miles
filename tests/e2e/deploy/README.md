...
- **Weight checks**: same-version consistency and per-tensor adjacent-version movement (except LoRA or non-unit update intervals). Checks run in the soak package, never as production publication gates.
