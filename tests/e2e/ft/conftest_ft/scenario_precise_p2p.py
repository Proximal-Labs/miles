import typer
from tests.e2e.ft.conftest_ft.cli_options import FullyAsyncOption, ModeOption, NumStepsOption
...
def run_ci(
    ...
    run_random_crash(mode=mode, seed=seed, num_steps=num_steps, fully_async=fully_async, precise_p2p=True)
