...
- **Once per rollout**, the trainer seals the session and fetches its samples from the replica, and writes them to its rollout store; it remains the store's only writer.
