"""Fail before a Terminal-Bench policy update if an auxiliary MTP head is present."""
...
def _check_fresh_initialization(args: Namespace) -> None:
    """Only the original HF checkpoint may initialize this recipe."""
    if args.load != args.hf_checkpoint or args.ref_load != args.hf_checkpoint:
        raise ValueError("Expected fresh original HF weights, not a training checkpoint")
