...
three-node H200 allocation: one eight-GPU trainer and two eight-GPU rollout
engines.
"""
...
class ScriptArgs(U.ExecuteTrainConfig):
    ...
    run_id: str = "260916-cbd29e51"
    model_name: str = "Qwen3.6-35B-A3B-SFT-260906-dfca12ed-iter559"
    megatron_model_type: str = "qwen3.6-35B-A3B"
    num_gpus_per_node: int = 8
    megatron_path: str = "/root/Megatron-LM"

    hf_checkpoint: str = "/scratch/models/Qwen3.6-35B-A3B-SFT-260906-dfca12ed-iter559"
    ref_load: str = "/scratch/models/Qwen3.6-35B-A3B-SFT-260906-dfca12ed-iter559_torch_dist"
    output_dir: str = "/scratch/terminal-universe-training"
    tasks_dir: str = "/scratch/terminal-universe-training/260916-cbd29e51/data/tasks"
    template_map: str = "/scratch/terminal-universe-training/260916-cbd29e51/data/e2b_templates.json"
    harbor_dir: str = "/scratch/terminal-universe-training/260916-cbd29e51/code/harbor"
    ...
    wandb_run_name: str = "260916-qwen36-35b-a3b-terminal-universe316-async3n-r3-retract-sft559-lr3e7-cbd29e51"

    def __post_init__(self) -> None:
        if self.num_nodes != 3:
            raise ValueError("this recipe requires exactly three nodes")
...
def write_prompt_data(args: ScriptArgs) -> None:
    ...
    if len(tasks) != 316 or any(not task.get("ready") for task in tasks):
        raise ValueError("template map must contain exactly 316 ready tasks")
...
def train_args(args: ScriptArgs) -> str:
    ...
    if rollout_gpus != 16:
        raise ValueError("expected two eight-GPU rollout nodes")
    ...
    wandb_args = ""
    if args.wandb_key:
        wandb_args = f"--use-wandb --wandb-key {args.wandb_key} --wandb-team {args.wandb_team} --wandb-project {args.wandb_project} --wandb-group {args.wandb_run_name} --wandb-dir {root / 'wandb'} --disable-wandb-random-suffix "
    misc_args = (
