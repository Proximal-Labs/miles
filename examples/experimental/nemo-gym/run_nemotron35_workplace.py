...
and the NeMo Gym Workplace Assistant verifier. The model starts from original HF weights. The native resource service owns\ntool state and binary reward; all policy turns use Miles TITO sessions.
...
class ScriptArgs(U.ExecuteTrainConfig):
    ...
    pause_generation_mode: str = "abort"
    wandb_team: str = "radixarkai"
    wandb_project: str = "nemotron35-workplace-assistant"
...
def execute(args: ScriptArgs) -> None:
    ...
    U.execute_train(
        ...
        extra_env_vars={
            ...
            "WORKPLACE_MODEL_PATH": checkpoint,
